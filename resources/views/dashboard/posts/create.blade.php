    ...
    <center>
        <form action="{{ route('dashboard.posts.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body shadow mb-4 col-10">
                <a style="margin-left: 95ch" class="btn btn-primary" href="{{ route('dashboard.posts.index') }}">Show Posts</a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <textarea name="small_desc" value="{{ @old('small_desc') }}" placeholder="Enter Post Small Description"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <textarea id="postContent" name="desc" value="{{ @old('desc') }}" placeholder="Enter Description"
                                class="form-control"></textarea>
                            @error('desc')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
