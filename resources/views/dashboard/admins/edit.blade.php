        ...
        <form action="{{ route('dashboard.admins.update', $admin->id) }}" method="post">
            ...
            <div class="card-body shadow mb-4" style="min-width: 75ch">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Name: <input value="{{ $admin->name }}" type="text" name="name"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Username<input value="{{ $admin->username }}" type="text" name="username"
                                placeholder="Enter Admin Username" class="form-control">
                            @error('username')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Email:<input value="{{ $admin->email }}" type="email" name="email"
                        ...
                        <div class="form-group">
                            Select Role:<select name="role_id" class="form-control">
                                ...
                                @forelse ($authorizations as $authorization)
                                    <option value="{{ $authorization->id }}" @selected($admin->role_id == $authorization->id)>
