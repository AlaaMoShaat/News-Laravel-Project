        ...
        <form action="{{ route('dashboard.admins.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body shadow mb-4" style="min-width: 75ch">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Name: <input type="text" name="name" placeholder="Enter Admin name"
                                class="form-control">
                            @error('name')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Username<input type="text" name="username" placeholder="Enter Admin Username"
                                class="form-control">
                            @error('username')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Email:<input type="email" name="email" placeholder="Enter Admin Email"
                                class="form-control">
                            @error('email')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
