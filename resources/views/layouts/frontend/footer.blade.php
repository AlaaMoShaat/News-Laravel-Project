            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-widget">
                    ...
                    <div class="contact-info">
                        <p>
                            <i class="fa fa-map-marker"></i>{{ $get_setting->street }}, {{ $get_setting->city }},
                            {{ $get_setting->country }}
                        </p>
                        <p>
                            <i class="fa fa-envelope"></i>{{ $get_setting->email }}
                        </p>
                        <p><i class="fa fa-phone"></i>{{ $get_setting->phone }}</p>
                        <div class="social">
                ...
                <div class="footer-widget">
                    ...
                    <ul>
                        @foreach ($relatedSites as $relatedSite)
                            <li><a href="{{ $relatedSite->url }}"
                                    title="{{ $relatedSite->name }}">{{ $relatedSite->name }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 copyright">
                <p>
                    Copyright &copy; <a href="">{{ env('APP_NAME') }}</a>. All
                    Rights Reserved
                </p>
            </div>
